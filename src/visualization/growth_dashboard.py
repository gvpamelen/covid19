...
def growth_tab():
    """
    Plots for the growth tab.
    Details behind the plots in notebook/plots/1_covid_control.ipynb
    """
    ...
    start_date = first_date #'2020-03-10' #'2020-02-01'
